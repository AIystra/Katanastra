...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    DEMON("demon", 50, new int[]{3, 6, 8, 3}, 17,
            SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 4.0F, 0.5F, () -> {
        return Ingredient.ofItems(new ItemConvertible[]{ModItem.BLOOD_INFUSED_NETHERITE});
    }),
    PLATINIUM("platinium", 30, new int[]{2, 5, 6, 2}, 17,
            SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 0.0F, 0.1F, () -> {
    ...
    public String getName() {
        return katanastraMod.MODID + ":" + this.name;
    }
